...
@DownloadEngines(downloadEngines = {
    @DownloadEngine(systemType = "ULAKCORE", measType = "PM", operatorName = "HTK")}
)
public class Ulak5GDownloadEngine extends DefaultTimeBasedEngine {

    public Ulak5GDownloadEngine(ServerIpList eachIp) {
        super(eachIp);
    }
