...
@DownloadEngines(downloadEngines = {
    @DownloadEngine(systemType = "HAVRADIO", measType = "PM", operatorName = "HTK")}
)
public class HavRadio5GDownloadEngine extends DefaultTimeBasedEngine {

    public HavRadio5GDownloadEngine(ServerIpList eachIp) {
        super(eachIp);
    }
