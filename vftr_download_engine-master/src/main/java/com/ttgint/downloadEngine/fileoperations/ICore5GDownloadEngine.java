...
@DownloadEngines(downloadEngines = {
    @DownloadEngine(systemType = "ICORE", measType = "PM", operatorName = "HTK")}
)
public class ICore5GDownloadEngine extends DefaultTimeBasedEngine {

    public ICore5GDownloadEngine(ServerIpList eachIp) {
        super(eachIp);
    }
